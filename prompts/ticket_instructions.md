   ...
   {{
     ...
     "worktrees": [
       {{
         ...
         "pr_description": "<markdown PR description. The structure depends on the issue type:\n\nIf the issue type is Bug:\n## Summary\n<brief description of the bug and what it caused>\n\n## Root cause\n<explain what was causing the bug>\n\n## Why this fix\n<explain why this approach is the correct fix, not just what was changed>\n\n## Changes\n- <notable change 1>\n- <notable change 2>\n\n## Testing checklist\n- [ ] <specific manual test step based on what you changed>\n- [ ] <another specific step>\n\nIf the issue type is NOT Bug (e.g. Task, Story, etc.):\n## Summary\n<brief description of what was implemented, referencing {key}>\n\n## What changed\n<prose explanation of what was changed and why — more than a bullet list, enough context for a reviewer to understand the scope>\n\n## Changes\n- <notable change 1>\n- <notable change 2>\n\n## Testing checklist\n- [ ] <specific manual test step based on what you changed>\n- [ ] <another specific step>\n\nWrite test steps that are concrete and actionable (e.g. 'Open the video editor and trim a clip' not 'Test the feature'). Include only steps relevant to what you actually changed.>"
       }}
     ]
   }}
